...
class QfxImporter {
  ...
  public function __construct(QfxParser $ofx_Parser, EntityTypeManagerInterface $entity_type_manager) {
    $this->qfxParser = $ofx_Parser;
  ...
  public function import($file) {
    $ofx_data = $this->qfxParser->get($file);
